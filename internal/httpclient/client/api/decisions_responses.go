...
func (o *DecisionsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /decisions] decisions", response, response.Code())
	}
}
...
// Code gets the status code for the decisions o k response
func (o *DecisionsOK) Code() int {
	return 200
}
...
// Code gets the status code for the decisions unauthorized response
func (o *DecisionsUnauthorized) Code() int {
	return 401
}

func (o *DecisionsUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /decisions][%d] decisionsUnauthorized %s", 401, payload)
}
...
// Code gets the status code for the decisions forbidden response
func (o *DecisionsForbidden) Code() int {
	return 403
}

func (o *DecisionsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /decisions][%d] decisionsForbidden %s", 403, payload)
}
...
// Code gets the status code for the decisions not found response
func (o *DecisionsNotFound) Code() int {
	return 404
}

func (o *DecisionsNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /decisions][%d] decisionsNotFound %s", 404, payload)
}
...
// Code gets the status code for the decisions internal server error response
func (o *DecisionsInternalServerError) Code() int {
	return 500
}

func (o *DecisionsInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /decisions][%d] decisionsInternalServerError %s", 500, payload)
}
