...
func (o *IsInstanceReadyReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 503:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /health/ready] isInstanceReady", response, response.Code())
	}
}
...
// Code gets the status code for the is instance ready o k response
func (o *IsInstanceReadyOK) Code() int {
	return 200
}

func (o *IsInstanceReadyOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /health/ready][%d] isInstanceReadyOK %s", 200, payload)
}
...
// Code gets the status code for the is instance ready service unavailable response
func (o *IsInstanceReadyServiceUnavailable) Code() int {
	return 503
}

func (o *IsInstanceReadyServiceUnavailable) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /health/ready][%d] isInstanceReadyServiceUnavailable %s", 503, payload)
}
