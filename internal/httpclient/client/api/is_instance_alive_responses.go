...
func (o *IsInstanceAliveReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /health/alive] isInstanceAlive", response, response.Code())
	}
}
...
// Code gets the status code for the is instance alive o k response
func (o *IsInstanceAliveOK) Code() int {
	return 200
}

func (o *IsInstanceAliveOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /health/alive][%d] isInstanceAliveOK %s", 200, payload)
}
...
// Code gets the status code for the is instance alive internal server error response
func (o *IsInstanceAliveInternalServerError) Code() int {
	return 500
}

func (o *IsInstanceAliveInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /health/alive][%d] isInstanceAliveInternalServerError %s", 500, payload)
}
