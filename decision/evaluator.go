...
type Evaluator struct {
	...
	Warden   keto.WardenSDK
	Issuer  string
}

func NewWardenEvaluator(l logrus.FieldLogger, m rule.Matcher, s keto.WardenSDK, i string) *Evaluator {
	if l == nil {
		l = logrus.New()
	}
...
func (d *Evaluator) EvaluateAccessRequest(r *http.Request) (*Session, error) {
	var u = *r.URL
	u.Host = r.Host
	u.Scheme = "http"
	if r.TLS != nil {
...
func (d *Evaluator) prepareAccessRequests(r *http.Request, u string, token string, rl *rule.Rule) swagger.WardenTokenAccessRequest {
