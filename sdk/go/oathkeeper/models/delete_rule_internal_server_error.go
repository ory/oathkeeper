...
// swagger:model DeleteRuleInternalServerError
...
func (m *DeleteRuleInternalServerError) validatePayload(formats strfmt.Registry) error {
...
func (m *DeleteRuleInternalServerError) UnmarshalBinary(b []byte) error {
	var res DeleteRuleInternalServerError
