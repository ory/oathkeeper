...
;(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.OryOathkeeper.Rule = factory(
      root.OryOathkeeper.ApiClient,
      root.OryOathkeeper.RuleHandler,
      root.OryOathkeeper.RuleMatch,
      root.OryOathkeeper.Upstream
    )
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('authenticators')) {
        obj['authenticators'] = ApiClient.convertToType(
          data['authenticators'],
          [RuleHandler]
        )
      }
      ...
      if (data.hasOwnProperty('credentials_issuer')) {
        obj['credentials_issuer'] = RuleHandler.constructFromObject(
          data['credentials_issuer']
        )
      }
