...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.OryOathkeeper.SwaggerRuleMatch = factory(root.OryOathkeeper.ApiClient);
  }
  ...
  /**
   * The SwaggerRuleMatch model module.
   * @module model/SwaggerRuleMatch
   * @version Latest
   */

  /**
   * Constructs a new <code>SwaggerRuleMatch</code>.
   * SwaggerRuleMatch swagger rule match
   * @alias module:model/SwaggerRuleMatch
   * @class
   */
  ...
  /**
   * Constructs a <code>SwaggerRuleMatch</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SwaggerRuleMatch} obj Optional instance to populate.
   * @return {module:model/SwaggerRuleMatch} The populated <code>SwaggerRuleMatch</code> instance.
   */
