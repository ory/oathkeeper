...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.OryOathkeeper.RuleHandler = factory(root.OryOathkeeper.ApiClient);
  }
  ...
  /**
   * The RuleHandler model module.
   * @module model/RuleHandler
   * @version Latest
   */

  /**
   * Constructs a new <code>RuleHandler</code>.
   * @alias module:model/RuleHandler
   * @class
   */
  ...
  /**
   * Constructs a <code>RuleHandler</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RuleHandler} obj Optional instance to populate.
   * @return {module:model/RuleHandler} The populated <code>RuleHandler</code> instance.
   */
