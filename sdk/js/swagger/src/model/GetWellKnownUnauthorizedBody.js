...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.OryOathkeeper.GetWellKnownUnauthorizedBody = factory(root.OryOathkeeper.ApiClient);
  }
  ...
  /**
   * The GetWellKnownUnauthorizedBody model module.
   * @module model/GetWellKnownUnauthorizedBody
   * @version Latest
   */
  ...
  /**
   * Constructs a <code>GetWellKnownUnauthorizedBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetWellKnownUnauthorizedBody} obj Optional instance to populate.
   * @return {module:model/GetWellKnownUnauthorizedBody} The populated <code>GetWellKnownUnauthorizedBody</code> instance.
   */
