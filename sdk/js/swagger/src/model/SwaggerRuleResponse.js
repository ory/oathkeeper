...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.OryOathkeeper.SwaggerRuleResponse = factory(root.OryOathkeeper.ApiClient, root.OryOathkeeper.SwaggerRule);
  }
   ...
   * @module model/SwaggerRuleResponse
   * @version Latest
   */

  /**
   * Constructs a new <code>SwaggerRuleResponse</code>.
   * SwaggerRuleResponse A rule
   * @alias module:model/SwaggerRuleResponse
   * @class
   */
   ...
   * @param {module:model/SwaggerRuleResponse} obj Optional instance to populate.
   * @return {module:model/SwaggerRuleResponse} The populated <code>SwaggerRuleResponse</code> instance.
   */
