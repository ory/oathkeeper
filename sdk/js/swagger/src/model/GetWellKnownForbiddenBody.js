...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.OryOathkeeper.GetWellKnownForbiddenBody = factory(root.OryOathkeeper.ApiClient);
  }
  ...
  /**
   * The GetWellKnownForbiddenBody model module.
   * @module model/GetWellKnownForbiddenBody
   * @version Latest
   */
  ...
  /**
   * Constructs a <code>GetWellKnownForbiddenBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetWellKnownForbiddenBody} obj Optional instance to populate.
   * @return {module:model/GetWellKnownForbiddenBody} The populated <code>GetWellKnownForbiddenBody</code> instance.
   */
