...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.OryOathkeeper.UpdateRuleNotFoundBody = factory(root.OryOathkeeper.ApiClient);
  }
  ...
  /**
   * The UpdateRuleNotFoundBody model module.
   * @module model/UpdateRuleNotFoundBody
   * @version Latest
   */
  ...
  /**
   * Constructs a <code>UpdateRuleNotFoundBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UpdateRuleNotFoundBody} obj Optional instance to populate.
   * @return {module:model/UpdateRuleNotFoundBody} The populated <code>UpdateRuleNotFoundBody</code> instance.
   */
