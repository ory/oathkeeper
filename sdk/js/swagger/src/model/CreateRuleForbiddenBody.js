...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.OryOathkeeper.CreateRuleForbiddenBody = factory(root.OryOathkeeper.ApiClient);
  }
  ...
  /**
   * The CreateRuleForbiddenBody model module.
   * @module model/CreateRuleForbiddenBody
   * @version Latest
   */
  ...
  /**
   * Constructs a <code>CreateRuleForbiddenBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CreateRuleForbiddenBody} obj Optional instance to populate.
   * @return {module:model/CreateRuleForbiddenBody} The populated <code>CreateRuleForbiddenBody</code> instance.
   */
