...
s!ory://logging-config!https://raw.githubusercontent.com/ory/x/$ory_x_version/logrusx/config.schema.json!g" spec/config.schema.json > .schema/config.schema.json
