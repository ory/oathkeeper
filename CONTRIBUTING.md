...
# Contribute to Ory Oathkeeper<!-- omit in toc -->
...
won't clash with Ory Oathkeeper's direction. A great way to do this is via
[Ory Oathkeeper Discussions](https://github.com/ory/oathkeeper/discussions) or
the [Ory Chat](https://www.ory.com/chat).
...
- **Help with open issues.** We have a lot of open issues for Ory Oathkeeper and
...
1. Open a [Discussion](https://github.com/ory/oathkeeper/discussions/new/choose)
   or [Issue](https://github.com/ory/oathkeeper/issues/new/choose) describing
...
1. Add a descriptive prefix to commits. This ensures a uniform commit history
   ...
   [Convential Commits configuration](https://github.com/ory/oathkeeper/blob/master/.github/workflows/conventional_commits.yml)
...
maintain the quality and reliability of Ory Oathkeeper, please follow these
guidelines:
