#!/bin/sh
set -e
# Code generated by godownloader on 2019-04-08T10:43:58Z. DO NOT EDIT.
#

usage() {
  this=$1
  cat <<EOF
$this: download go binaries for github.com/ory/oathkeeper

Usage: $this [-b] bindir [-d] [tag]
  -b sets bindir or installation directory, Defaults to ./bin
  -d turns on debug logging
   [tag] is a tag from
   https://github.com/github.com/ory/oathkeeper/releases
